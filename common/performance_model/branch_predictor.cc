...
BranchPredictor* BranchPredictor::create(core_id_t core_id)
{
   try
   {
      ...
      else if (type == "pentium_m")
      {
         ...
         return new GsharePredictor("branch_predictor", core_id);
      }
      else if (type == "bimode") {
         return new BiModePredictor("branch_predictor", core_id);
      }
      else if (type == "perceptron") {
         return new PerceptronPredictor("branch_predictor", core_id);
      }
      else
      {
